...
{
    public partial class SysOpPerfoDiv : OCT_WEIGHT.Manager.Common.FrmBase
    {
        private DataTable dt_pnt;

        public SysOpPerfoDiv()
        {
            InitializeComponent();
        }
        ...
        public void QueryClick()
        {
            ...
            try
            {
                ...
                DataSet ds = DBConn.ExecuteDataSet2("SP_TB_WS02_0002_R2", dict);
        ...
        private void SysOpPerfoDiv_Load(object sender, EventArgs e)
        {
            BtnNew.PerformClick();
            ...
            //계량실적배분 조회는 품목구분이 7:제품만 조회되게 수정(2019-12-09 한민호)
            lueITEM_JUNG.EditValue = "7";
            lueITEM_JUNG.Enabled = false;
            lueINOUT_GUBUN.Enabled = false;
        }
