...
{
    public partial class FrmWeightSeinList : OCT_WEIGHT.Manager.Common.FrmBase
    {
        DataTable dt = new DataTable();
        DataRow row = null;
        public FrmWeightSeinList()
        {
            InitializeComponent();
        }
        ...
        private void BtnSearch_Click(object sender, EventArgs e)
        {
            ...
            //    DataSet ds = DBConn.ExecuteDataSet2("SP_FrmWeightSeinList_R", dict);
        ...
        private void FrmWeightSeinList_Load(object sender, EventArgs e)
        {
            ...
            //기간 추가(2020-05-14 한민호)
            dtMEA_DATE_TO.Text = DateTime.Now.ToString("yyyy-MM-dd");
        ...
        public void QueryClick()
        {
            ...
            {              
                ...
                //기간 추가(2020-05-14 한민호)
                dict.Add("P_MEA_DATE_TO", dtMEA_DATE_TO.Text.Replace("-", ""));
                ...
                DataSet ds = DBConn.ExecuteDataSet2("SP_MU_WEIGHT_SEIN_LIST_NEW_R", dict);
                if (ds.Tables[0].Rows.Count > 0)
                {
        ...
        //엑셀 추가(2020-05-14 한민호)
        private void btnExcel_Click_1(object sender, EventArgs e)
        {
            if (gvwMaster.DataRowCount == 0) return;
            try
            {
                string desktop = Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory);
                //바탕화면 경로 + 화면명
                gvwMaster.ExportToXls(desktop + "\\" + this.Text + ".xls");
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.ToString());
