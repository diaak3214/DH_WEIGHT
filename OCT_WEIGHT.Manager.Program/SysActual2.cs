...
{
    public partial class SysActual2 : OCT_WEIGHT.Manager.Common.FrmBase
    {
                    ...
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        for (int k = 0; k < dt2.Rows.Count; k++)
                        {
                            if (rows2[k]["ITEM_JUNG"].ToString() == "1")
                            {
                                ...
                                txtsubsource3.Text = rows2[k]["PNT_NOW"].ToString();
                                txtsubsource4.Text = rows2[k]["PNT_ALL"].ToString();
                            ...
                            else if (rows2[k]["ITEM_JUNG"].ToString() == "Z")
                            {
                                ...
                                txtbusanmul3.Text = rows2[k]["PNT_NOW"].ToString();
                                txtbusanmul4.Text = rows2[k]["PNT_ALL"].ToString();
                                checkboxset(ds2, START_DATE.Text.Trim(), END_DATE.Text.Trim(), _code,
                                    rows2[k]["ITEM_JUNG"].ToString());
                            }
                        }
