...
namespace OCT_WEIGHT.Manager
{
    public static class DBConn
    {
        private static string _connstr =
            ...
            //대한제강 운영계(WGDBO로 변경)
            "Data Source=(DESCRIPTION=(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST=192.168.110.43)(PORT=1524)))(CONNECT_DATA=(SID=WGDBO)));User Id=WGDBO;Password=WGDBO123";
            //대한제강 운영계
            //"Data Source=(DESCRIPTION=(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST=192.168.110.43)(PORT=1521)))(CONNECT_DATA=(SID=AWDBO)));User Id=AWDBO;Password=AWDBO";
            //대한제강 개발계
            //"Data Source=(DESCRIPTION=(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST=192.168.110.107)(PORT=1521)))(CONNECT_DATA=(SID=STAZDEV)));User Id=GATE;Password=GATE";
            //한국철강 내부망 가동계
            ...
            //한국철강 내부망 개발계
            //"Data Source=(DESCRIPTION=(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST=192.1.1.48)(PORT=1521)))(CONNECT_DATA=(SID=IODB)));User Id=AWDBO;Password=AWDBO";
