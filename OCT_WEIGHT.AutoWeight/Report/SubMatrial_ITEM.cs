...
{
    public partial class SubMatrial_ITEM : DevExpress.XtraReports.UI.XtraReport
    {
        public SubMatrial_ITEM(DataTable dt, String value1, String value2)
        {
            InitializeComponent();
            ...
            xrTableCell23.Text = "상차NO";
            xrTableCell25.DataBindings.Add("Text", ds, ds.Tables[0].Columns["IF_NO"].ColumnName);
            xrTableCell26.Text = value1;
            xrTableCell27.Text = value2 + "대";
        }         
    }
}
